    ...
    "paths": {
        "/FacePatient/FacePatient": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.FacePatientResponse"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "患者ID, 患者信息",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/face.FacePatient"
                        }
                    }
                ],
                "responses": {
        ...
        "/FacePatient/FacePatientList": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "分页获取权限患者列表,返回包括列表,总数,页码,每页数量",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/FacePhoto/FacePhoto": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.FacePhotoResponse"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "图片ID, 图片信息",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/face.FacePhoto"
                        }
                    }
                ],
                "responses": {
        ...
        "/FacePhoto/FacePhotoList": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "分页获取权限图片列表,返回包括列表,总数,页码,每页数量",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/FaceVideo/FaceVideo": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/response.FaceVideoResponse"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "视频ID, 视频信息",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/face.FaceVideo"
                        }
                    }
                ],
                "responses": {
        ...
        "/FaceVideo/FaceVideoList": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "分页获取权限视频列表,返回包括列表,总数,页码,每页数量",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
